...
#define configCPU_CLOCK_HZ                        CPU_CORE_CLK_HZ /* CPU core clock */
#define configBUS_CLOCK_HZ                        CPU_BUS_CLK_HZ /* CPU bus clock */
...
#define configSYSTICK_CLOCK_HZ                    ((CPU_CORE_CLK_HZ)/configSYSTICK_CLOCK_DIVIDER) /* frequency of system tick counter */
