...
**     Component   : FreeRTOS
**     Version     : Component 01.303, Driver 01.00, CPU db: 3.00.000
**     Compiler    : GNU C Compiler
**     Date/Time   : 2013-10-04, 05:48, # CodeGen: 1
**     Abstract    :
...
**              Library Lowest Interrupt Priority          : 15
...
#define FRTOS1_xTaskCreate(pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pvCreatedTask) \
...
#define FRTOS1_vTaskStartScheduler() \
  vTaskStartScheduler()
/*
** ===================================================================
...
#define FRTOS1_taskENTER_CRITICAL() \
  taskENTER_CRITICAL()
/*
** ===================================================================
...
#define FRTOS1_taskEXIT_CRITICAL() \
  taskEXIT_CRITICAL()
/*
** ===================================================================
...
#define FRTOS1_taskDISABLE_INTERRUPTS() \
...
#define FRTOS1_taskENABLE_INTERRUPTS() \
...
#define FRTOS1_vTaskDelay(xTicksToDelay) \
...
#define FRTOS1_vTaskDelayUntil(pxPreviousWakeTime, xTimeIncrement) \
...
#define FRTOS1_uxTaskPriorityGet(pxTask) \
...
#define FRTOS1_vTaskPrioritySet(pxTask, uxNewPriority) \
...
#define FRTOS1_vTaskSuspend(pxTaskToSuspend) \
...
#define FRTOS1_vTaskResume(pxTaskToResume) \
...
#define FRTOS1_xSemaphoreCreateMutex() \
  xSemaphoreCreateMutex()
...
#define FRTOS1_xSemaphoreTake(xMutex, xBlockTime) \
...
#define FRTOS1_xSemaphoreGive(xMutex) \
...
#define FRTOS1_vSemaphoreCreateBinary(xSemaphore) \
...
#define FRTOS1_xSemaphoreCreateCounting(uxMaxCount, uxInitialCount) \
...
#define FRTOS1_xSemaphoreGiveFromISR(xSemaphore, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_vSemaphoreDelete(xSemaphore) \
...
#define FRTOS1_pvPortMalloc(xWantedSize) \
...
#define FRTOS1_xTaskGetTickCount() \
  xTaskGetTickCount()
/*
** ===================================================================
...
#define FRTOS1_xTaskGetSchedulerState() \
...
#define FRTOS1_uxTaskGetStackHighWaterMark(xTask) \
...
#define FRTOS1_uxTaskGetNumberOfTasks() \
...
#define FRTOS1_xPortGetFreeHeapSize() \
...
#define FRTOS1_xQueueCreate(uxQueueLength, uxItemSize) \
...
#define FRTOS1_xQueueSendToFront(xQueue, pvItemToQueue, xTicksToWait) \
...
#define FRTOS1_xQueueSendToBack(xQueue, pvItemToQueue, xTicksToWait) \
...
#define FRTOS1_xQueueReceive(xQueue, pvBuffer, xTicksToWait) \
...
#define FRTOS1_xQueuePeek(xQueue, pvBuffer, xTicksToWait) \
...
#define FRTOS1_vQueueDelete(pxQueueToDelete) \
...
#define FRTOS1_uxQueueMessagesWaiting(xQueue) \
...
#define FRTOS1_uxQueueMessagesWaitingfromISR(xQueue) \
...
#define FRTOS1_xQueueSendToFrontFromISR(xQueue, pvItemToQueue, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_xQueueSendToBackFromISR(xQueue, pvItemToQueue,pxHigherPriorityTaskWoken) \
...
#define FRTOS1_xTaskResumeFromISR(pxTaskToResume) \
...
#define FRTOS1_xQueueReset(xQueue) \
  xQueueReset(xQueue)
...
#define FRTOS1_xSemaphoreGetMutexHolder(xSemaphore) \
...
#define FRTOS1_xSemaphoreTakeFromISR(xSemaphore, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_xTaskGetTickCountFromISR() \
...
#define FRTOS1_xQueuePeekFromISR(xQueue, pvBuffer, xTicksToWait) \
...
#define FRTOS1_xQueueOverwrite(xQueue, pvItemToQueue, xTicksToWait) \
  xQueueOverwrite(xQueue, pvItemToQueue, xTicksToWait)
/*
** ===================================================================
...
#define FRTOS1_xQueueOverwriteFromISR(xQueue, pvItemToQueue, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_vQueueAddToRegistry(xQueue, pcQueueName) \
...
#define FRTOS1_vQueueUnregisterQueue(xQueue) \
...
#define FRTOS1_xQueueIsQueueFullFromISR(xQueue) \
...
#define FRTOS1_xQueueIsQueueEmptyFromISR(xQueue) \
